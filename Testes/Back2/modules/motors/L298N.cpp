...
L298N::L298N( const char* description = "L298N Driver", uint8_t direction = BDC_FORWARD, double speed = 0.0 )
  : Motor( description, direction, speed ) {
...
L298N::L298N( uint8_t direction = BDC_FORWARD, double speed = 0.0 ){
  L298N::L298N( "L298N", direction, speed );
}
    
L298N::L298N( void ){
  L298N::L298N( "L298N", BDC_FORWARD, 0.0 );
}
